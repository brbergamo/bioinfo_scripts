...
- Variant calling scripts (e.g., using GATK or bcftools)
- Metagenomic preprocessing workflows (e.g., for 16S or shotgun data)
- Quality control pipelines (FastQC, MultiQC)
- DESeq2 automation scripts in R
- Functional annotation tools integration (e.g., KEGG, GO, InterPro)
